 ...
 */
#ifndef MLPACK_CORE_OPTIMIZERS_WN_GRAD_WN_GRAD_HPP
#define MLPACK_CORE_OPTIMIZERS_WN_GRAD_WN_GRAD_HPP
 ...
 * @endcode
 *
 * For WNGrad to work, a DecomposableFunctionType template parameter is
