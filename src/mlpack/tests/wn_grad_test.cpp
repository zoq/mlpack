...
#include <mlpack/core/optimizers/wn_grad/wn_grad.hpp>
...
BOOST_AUTO_TEST_SUITE(WNGradTest);

/**
 * Run WNGrad on logistic regression and make sure the results are acceptable.
 */
BOOST_AUTO_TEST_CASE(WNGradLogisticRegressionTest)
{
 ...
 */
BOOST_AUTO_TEST_CASE(WNGradSphereFunctionTest)
{
  SphereFunction f(2);
 ...
 */
BOOST_AUTO_TEST_CASE(WNGradStyblinskiTangFunctionTest)
{
